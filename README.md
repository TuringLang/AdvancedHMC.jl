...
<details>
 ...
 The Euclidean metric is also known as the mass matrix in the physical perspective. For available metrics refer <a name="hamiltonian-mass-matrix-metric">Hamiltonian mass matrix</a>.
</details>
